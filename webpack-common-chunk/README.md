...
chunk    {1} pageA.js (pageA) 132 bytes {0} [initial] [rendered]
    > pageA [5] ./pageA.js 
    [2] ./utility1.js 28 bytes {1} [built]
        cjs require ./utility1 [5] ./pageA.js 1:15-36
    [5] ./pageA.js 104 bytes {1} [built]
...
common.js   92 bytes       0  [emitted]  common
 pageA.js  104 bytes       1  [emitted]  pageA
